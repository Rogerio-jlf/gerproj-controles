...
function Header({
    ...
    return (
        <header className="flex flex-col gap-3 bg-purple-900 p-3 lg:gap-4 lg:p-4">
            ...
            <div className="flex w-full items-center justify-between gap-2">
                ...
                <FiRefreshCw
                    ...
                    className="flex-shrink-0 cursor-pointer text-white transition-all hover:scale-125 hover:rotate-180 active:scale-95"
                    size={28}
                />
            </div>
            ...
            <div className="flex w-full flex-col items-start justify-between gap-3 lg:flex-row lg:items-center">
                ...
                <div className="flex w-full flex-1 flex-wrap items-center justify-start gap-2 lg:w-auto">
                    <BadgeTotalizador
                        label={
                            totalChamadosFiltrados === 1
                                ? 'Chamado'
                                : 'Chamados'
                        }
                        valor={totalChamadosFiltrados}
                        valorTotal={
                            hasActiveFilters ? totalChamados : undefined
                        }
                    />
            ...
            {table.getHeaderGroups().map((headerGroup: any) => (
                <tr key={headerGroup.id}>
                    {headerGroup.headers.map((header: any, idx: number) => (
                        <th
                            key={header.id}
                            className="relative border-r border-teal-900 bg-teal-700 px-2 py-2 shadow-sm shadow-black lg:px-3 lg:py-3"
            ...
            <tbody>
                <tr>
                    <td
                        ...
                        className="py-20 text-center lg:py-40"
                    >
        ...
        <tbody className="relative">
            {rows.map((row: any, rowIndex: number) => {
                const handleChamadoClick =
                    table.options.meta?.handleChamadoClick;
