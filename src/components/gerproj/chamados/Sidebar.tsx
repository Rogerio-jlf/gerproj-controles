...
export function Sidebar() {
    ...
    return (
        <>
            ...
            <nav
                className={`group/sidebar flex h-full flex-col items-center overflow-hidden rounded-xl border border-purple-950 bg-black text-white transition-all duration-200 ease-in-out ${
                    isMobile
