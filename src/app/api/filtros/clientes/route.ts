// src/app/api/filtros/clientes/route.ts - CORRIGIDO
...
function validarParametros(searchParams: URLSearchParams): QueryParams | NextResponse {
    ...
    return { isAdmin, codCliente, codRecurso, mes, ano };
}
...
export async function GET(request: Request) {
    try {
        ...
        const { sql: sqlFinal, params: sqlParams } = aplicarFiltros(SQL_CLIENTES_BASE, params, [
            dataInicio,
            dataFim,
        ]);
